...
class DaylightCalculatorPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Калькулятор длины дня'),
        actions: [
          IconButton(
      ...
      children: [
        TextField(
          ...
          decoration: const InputDecoration(
            labelText: 'Введите координаты (широта,долгота)',
            hintText: 'ш.д. 52.5200,13.4050',
        ...
        ElevatedButton(
          onPressed: () {
            if (locationController.text.isNotEmpty) {
              context.read<DaylightCubit>().calculateDaylight(
